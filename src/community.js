  ...
  <Link className="uline mt-1" to="/Home"><img src={logo} style={{height:"30px"}} className="mt-3"></img></Link>
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="me-auto mt-3">
          ...
          <Link className="uline mt-1" to="/Community">Community</Link>
...
<Container>
<h1 className="mt-5"><b>Join the LBT Community</b></h1>
<h4 className="mt-3">The LBT Community includes lawyers, arbitration chambers, regulators, companies, developers,
     and legal tech enthusiasts.
</h4>
<h4 className="mt-3">LBT's community has been developed over time, incorporating scientific, technical and legal
     experts from all around the world. Are you one of us? 
</h4>
...
<Row className="bg mt-5">
    ...
    <Row className="justify-content-center footer">
        ...
        <Col lg={2} sm={2} className="ms-3 mt-4">
            ...
            <p className="form fonts fsize1"><Link className="uline mt-1 white fsize1" to="/AboutTeam">About Team</Link></p>
        </Col>
        <Col lg={2} sm={2} className="ms-3 mt-4">
